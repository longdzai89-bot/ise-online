class SplashScene extends Phaser.Scene {
  ...
  preload() {
    ...
    const bar = this.add.rectangle(480, 300, 0, 8, 0x4ade80);
    const bg = this.add.rectangle(480, 300, 400, 8, 0x1e3a2e);
  ...
  create() {
    const splash = this.add.image(480, 270, 'splash');
    splash.setDisplaySize(960, 540);
